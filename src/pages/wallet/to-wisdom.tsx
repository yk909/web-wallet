...
ToWISDOM.getLayout = (page: React.ReactElement) => <DashboardLayout>{page}</DashboardLayout>;

// ----------------------------------------------------------------------

export default function ToWISDOM() {
  ...
  return (
    <>
      <Head>
        <title> Newwit - To WISDOM</title>
      </Head>

      <CustomContainer bgcolor="white">
        <Box>
          <SubHeader title="To WISDOM" back={PATH_WALLET.dashboard} />
        </Box>
